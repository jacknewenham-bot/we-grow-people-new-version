...
const WHATSAPP_LINK = "https://wa.me/60173552382?text=Hi%20there%2C%20I'm%20interested%20in%20your%20Operations%20Training%20programs";
            ...
            <main className="pt-20">
                ...
                <section className="py-20 md:py-32 bg-hero text-hero relative overflow-hidden">
                    ...
                    <div className="container max-w-5xl text-center relative z-10">
                        ...
                        >
                            Operations training built for <br />
                        ...
                        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
                            ...
                            <div className="flex-1 bg-muted/30 p-12 rounded-[3rem] border border-border relative">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="h-4 w-full bg-destructive/5 rounded-full" />
                                    <p className="text-sm font-bold text-destructive uppercase tracking-tighter opacity-50">Process-heavy frameworks without real execution</p>
                                </div>
                            </div>
                        </div>
                    </div>
