                        ...
                        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
                            ...
                            <div className="flex-1 bg-muted/30 p-12 rounded-[3rem] border border-border relative">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="h-4 w-full bg-destructive/5 rounded-full" />
                                    <p className="text-sm font-bold text-destructive uppercase tracking-tighter opacity-50">Generic leadership frameworks without daily relevance</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 bg-hero text-hero">
                    <div className="container max-w-4xl">
                        ...
                        <div className="text-center">
                            <p className="text-xl mb-10 text-hero-muted italic">If several of these sound familiar, focused management training can quickly raise the baseline.</p>
