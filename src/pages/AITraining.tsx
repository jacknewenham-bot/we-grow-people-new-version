...
const WHATSAPP_LINK = "https://wa.me/60173552382?text=Hi%20there%2C%20I'm%20interested%20in%20your%20AI%20Training%20programs";
                        ...
                        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
                            ...
                            <div className="flex-1 bg-muted/30 p-12 rounded-[3rem] border border-border relative">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="h-4 w-full bg-destructive/5 rounded-full" />
                                    <p className="text-sm font-bold text-destructive uppercase tracking-tighter opacity-50">Generic AI demos without real application</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 bg-hero text-hero">
                    <div className="container max-w-4xl">
                        ...
                        <div className="text-center">
                            <p className="text-xl mb-10 text-hero-muted italic">If several of these sound familiar, structured AI training can quickly unlock value.</p>
